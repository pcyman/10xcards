...
The components are available in the `src/components/ui` folder, according to the aliases in the `components.json` file.
...
Many other components are available, but they are not currently installed. The full list can be found at https://ui.shadcn.com/r.
...
This project uses the “new-york” style variant with the base color “neutral” and CSS variables to create themes, as configured in the `components.json` section.
